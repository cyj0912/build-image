...
sudo debootstrap --arch=arm64 --extra-suites=jammy-updates,jammy-security --components=main,restricted,universe,multiverse jammy ${rootfs} http://ports.ubuntu.com/ubuntu-ports
